...
export const Movie: React.FC<ApiMoviesResult> = (movies) => {
  const navigate = useNavigate();
  return (
    <>
      <div
        className="w-full h-[50vh] rounded-md flex items-start flex-col gap-2 cursor-pointer transition-all ease-linear"
        onClick={() => {
      ...
      >
        ...
        <span className="text-white">
          ...
          <div className="flex flex-row items-center gap-x-2">
            <img src="public\img\start.svg" alt="start" className="w-5 h-5" />
